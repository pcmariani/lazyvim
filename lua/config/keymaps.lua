...
vim.keymap.set("n", "<Leader>by", "mtgg0vG", { noremap = true, desc = "Yank Buffer" })
...
-- Select all
vim.keymap.set("n", "<C-a>", "gg0vG$", { noremap = true, silent = true, desc = "Select All" }) -- TODO:don't add gg to jump list
